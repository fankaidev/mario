...
| UC-PORTFOLIO-006-S03 | P0 | ✅ | Given portfolio with cash_balance=1000, When attempting to withdraw 2000 USD, Then return 400 error "insufficient cash balance" | R3 |
...
| UC-PORTFOLIO-006-S09 | P1 | ✅ | Given deposit 10000 then withdrawal 6000 (balance=4000), When attempting to delete deposit, Then return 400 error "would result in negative cash balance" | R7, R3 |
